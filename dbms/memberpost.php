            ...
            <div class="main m0-a">
                <div class="row">
                    <div class="col-md-12 ta-c">
                        <h1 class="fz-30 mt-32 mb-32">已發布貼文</h1>
                    </div>
                </div>
                ...
                <ul class="row post-list">
                    <?php
                        ...
                        $mId = $_SESSION['mId'];
                        $sql = $db->query("SELECT *FROM`addpost` WHERE creater_mId = $mId ORDER BY 'pId' DESC");
                        $num = $sql->rowCount();
                        $time = 1;
                        foreach ($sql as $row) {
                                $pId = $row['pId'];
                    ...
                    <li class="col-md-4">
                        <div class="outer">
                            <a class="p-detail" href='updatepost.php?pId=<?= $row['pId']?>'>
                                <div class="upper">
