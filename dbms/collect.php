            ...
            <div class="main m0-a">
                <div class="row">
                    <div class="col-md-12 ta-c">
                        <h1 class="fz-30 mt-32 mb-32">收藏貼文</h1>
                    </div>
                </div>
                ...
                <ul class="row post-list">
                    <?php
                        ...
                        $mId = $_SESSION['mId'];
                        $sql = $db->query("SELECT *FROM`addpost` JOIN `favorite` ON addpost.pId = favorite.pId WHERE favorite.mId= $mId ORDER BY addpost.pId DESC");
                        $num = $sql->rowCount();
                        $time = 1;
                        foreach ($sql as $row) {
                            $pId = $row['pId'];
