...
<div class="wrap">
  ...
  <div class="container" >
      <div class="main register_form m0-a">
          <h1 class="ta-c fz-30 mt-32 mb-32">登入帳號</h1>
          ...
          <input type="hidden" id="method" name="method" value="1">
            <p class='field required error'>
              ...
              <input class='text-input' id='username' name='username' type='text' placeholder="user">
            </p>
            <p class='field required error pr-16'>
            ...
            <div class='field half1 ta-r'>
                ...
                <input class='btn btn-outline-danger w-72px' type='submit' value='登入'>
                <input type="hidden" value=" " name="register">
                <a class='btn btn-outline-success  w-72px' href="register.php" type='submit' value=''>註冊</a>
